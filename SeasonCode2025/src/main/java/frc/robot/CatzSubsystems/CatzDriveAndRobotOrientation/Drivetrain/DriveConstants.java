...
public class DriveConstants {
  ...
  static{
    switch(CatzConstants.getRobotType()){
        ...
        case SN1:
            MODULE_CONFIGS[INDEX_FR] = new ModuleIDs(1, 2, 11, -0.517, false);
            MODULE_CONFIGS[INDEX_BR] = new ModuleIDs(3, 4, 12, -0.717, false);
            MODULE_CONFIGS[INDEX_BL] = new ModuleIDs(5, 6, 13, 0.595, false);
            MODULE_CONFIGS[INDEX_FL] = new ModuleIDs(7, 8, 14, 0.631, false);
        break;
