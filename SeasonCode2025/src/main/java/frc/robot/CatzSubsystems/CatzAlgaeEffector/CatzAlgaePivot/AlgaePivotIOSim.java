...
public class AlgaePivotIOSim implements AlgaePivotIO{
    ...
    public void updateInputs(AlgaePivotIOInputs inputs) {
        ...
        elevatorHeightInch = ElevatorIOSim.getElevatorPositionInch();
        Logger.recordOutput("FinalComponentPoses", new Pose3d[] {new Pose3d(0.0, 0.0, Units.inchesToMeters(ElevatorIOSim.getElevatorPositionInch()) / 2, new Rotation3d(0.0, Math.PI / 2, 0.0)),
