...
public class CatzDrivetrain extends SubsystemBase {
    ...
    public void drive(ChassisSpeeds chassisSpeeds) {
        chassisSpeeds = ChassisSpeeds.discretize(chassisSpeeds, DriveConstants.LOOP_DELTA_TIME_SEC);
        //--------------------------------------------------------
    ...
    public void stopDriving() {
        ...
        //Iterate through the array of swerve modules and set the driving/steering power to zero.
        for (CatzSwerveModule module : m_swerveModules) {
            module.stopDriving();
