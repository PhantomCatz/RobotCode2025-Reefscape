...
public class Alert {
  ...
  private String text;
  private boolean isOnStateChange;
   ...
   */
  public void set(boolean active) { // TODO set message level priorities 1-5 if 1 is only certain ones increasing numebrs = increasing amounts of needed errors
    
    if(isOnStateChange) {
      hasStateChanged = active != this.active;
    }
